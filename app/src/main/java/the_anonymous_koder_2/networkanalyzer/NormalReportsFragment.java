...
public class NormalReportsFragment extends Fragment {
    ...
    public static NormalReportsFragment newInstance(){
        return new NormalReportsFragment();
    }

    public NormalReportsFragment() {
    ...
    private void initViews() {
        ...
        recyclerView.setAdapter(new ReportAdapter(db.fetchNormalReports()));
    }
